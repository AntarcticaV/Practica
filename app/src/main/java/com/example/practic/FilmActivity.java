...
public class FilmActivity extends AppCompatActivity {
    ...
    class ClAdapter extends BaseAdapter {
        ...
        public View getView(int i, View convertView, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = lInflater.inflate(R.layout.cl_adapter_on3, viewGroup, false);
            }
    ...
    class MyTask extends AsyncTask<String, Void, ArrayList<String[]>> {
        ...
        protected ArrayList<String[]> doInBackground(String... params) {
            ...
            try {
                URL mySite = new URL("http://10.0.2.2:8080/kino/index.php?id=2&name=" + params[0]);
        ...
        protected void onPostExecute(ArrayList<String[]> strings) {
            ...
            ClAdapter clAdapter = new ClAdapter(tvInfo.getContext(), strings);
