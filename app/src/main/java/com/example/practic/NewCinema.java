...
public class NewCinema extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_cinema);
        tvInfo = (TextView) findViewById(R.id.tvInfo);
        tvName = (EditText) findViewById(R.id.editTextTextPersonName);
        tvAdress = (EditText) findViewById(R.id.editTextTextPersonAddress);
    }

    public void onclick(View v) {
        mt = new NewCinema.MyTask();
        mt.execute(tvName.getText().toString(), tvAdress.getText().toString());
    }
